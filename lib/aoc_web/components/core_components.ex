defmodule AocWeb.CoreComponents do
  ...
  def flash(assigns) do
    ...
    <div
      ...
      class={[
        ...
        @kind == :info &&
          "bg-emerald-50 dark:bg-emerald-900 text-emerald-800 dark:text-emerald-200 ring-emerald-500 fill-cyan-900 dark:fill-cyan-200",
        @kind == :error &&
          "bg-rose-50 dark:bg-rose-900 text-rose-900 dark:text-rose-200 shadow-md ring-rose-500 fill-rose-900 dark:fill-rose-200"
      ]}
      {@rest}
    >
  ...
  def button(assigns) do
    ...
    <button
      type={@type}
      class={[
        "phx-submit-loading:opacity-75 rounded-lg bg-zinc-900 dark:bg-zinc-300 hover:bg-zinc-700 dark:hover:bg-zinc-400 py-2 px-3",
    ...
    <div>
      <label class="flex items-center gap-4 text-sm leading-6 text-zinc-600 dark:text-zinc-400">
        ...
        <input
          ...
          value="true"
          checked={@checked}
          class="rounded border-zinc-300 dark:border-zinc-700 text-zinc-900 dark:text-zinc-300 focus:ring-0"
          {@rest}
        />
        <%= @label %>
      </label>
  ...
  def input(%{type: "select"} = assigns) do
    ...
    <div>
      ...
      <select
        id={@id}
        name={@name}
        class="mt-2 block w-full rounded-md border border-gray-300 dark:border-gray-700 bg-white dark:bg-zinc-800 shadow-sm focus:border-zinc-400 dark:focus:border-zinc-600 focus:ring-0 sm:text-sm"
        multiple={@multiple}
        {@rest}
      >
  ...
  def input(%{type: "textarea"} = assigns) do
    ...
    <div>
      ...
      <textarea
        ...
        name={@name}
        class={[
          "mt-2 block w-full rounded-lg text-zinc-900 dark:text-zinc-100 focus:ring-0 sm:text-sm sm:leading-6 min-h-[6rem]",
          "bg-white dark:bg-zinc-800",
          @errors == [] &&
            "border-zinc-300 dark:border-zinc-700 focus:border-zinc-400 dark:focus:border-zinc-600",
          @errors != [] &&
            "border-rose-400 focus:border-rose-400 dark:border-rose-600 dark:focus:border-rose-600"
        ]}
        {@rest}
